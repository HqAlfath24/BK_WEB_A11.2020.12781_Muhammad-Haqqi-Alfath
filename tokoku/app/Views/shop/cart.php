                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="p-price first-row"><?php echo number_to_currency($item['diskon'] * $item['price'] * $item['qty'], 'IDR') ?></td>
                                        <td class="total-price first-row"><?php echo number_to_currency($item['price'] * $item['qty'] - $item['diskon'] * $item['qty'], 'IDR') ?></td>
