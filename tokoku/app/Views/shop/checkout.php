                ...
                <div class="place-order">
                    ...
                    <div class="order-total">
                        <ul class="order-table">
                            <li>Product diskon <span>Total</span></li>
                            <?php
                            if (!empty($items)) :
                                foreach ($items as $index => $item) :
                            ?>
                                    <li class="fw-normal"><?php echo $item['name'] ?> x <?php echo $item['qty'] ?> <span><?php echo number_to_currency($item['price'] * $item['qty'] - ($item['diskon'] * $item['price'] * $item['qty']), 'IDR') ?></span></li>
                            <?php
                                endforeach;
                            endif;
                            ?>
